		...
		var result = {
			...
			parse: function (input, startRule) {
				...
				function parse_section() {
							...
							if (result2 !== null) {
								...
								if (result3 !== null) {
									...
									if (result4 !== null) {
										...
										if (result5 !== null) {
											result6 = (function (offset, line, column, t, b, e, n) {
												return t[1].text === n.text;
											})(pos.offset, pos.line, pos.column, result0, result3, result4, result5) ? "" : null;
											if (result6 !== null) {
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, t, b, e, n) {
				...
				function parse_context() {
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, n) {
							return n
						})(pos1.offset, pos1.line, pos1.column, result0[1]);
					}
					if (result0 === null) {
						pos = clone(pos1);
					}
				...
				function parse_params() {
					...
					if (result1 !== null) {
						result1 = (function (offset, line, column, k, v) {
							return ["param", ["literal", k], v]
						})(pos1.offset, pos1.line, pos1.column, result1[1], result1[3]);
					}
					if (result1 === null) {
						pos = clone(pos1);
					}
				...
				function parse_bodies() {
					...
					if (result1 !== null) {
						result1 = (function (offset, line, column, k, v) {
							return ["param", ["literal", k], v]
						})(pos1.offset, pos1.line, pos1.column, result1[2], result1[4]);
					}
					if (result1 === null) {
						pos = clone(pos1);
					}
				...
				function parse_reference() {
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, n, f) {
				...
				function parse_partial() {
					...
					if (result0 !== null) {
						...
						if (result1 !== null) {
							...
							if (result2 !== null) {
								...
								result3 = parse_key();
								if (result3 !== null) {
									result3 = (function (offset, line, column, k) {
										return ["literal", k]
									})(pos2.offset, pos2.line, pos2.column, result3);
								}
								if (result3 === null) {
									pos = clone(pos2);
								}
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, s, n, c, p) {
							var key = (s === ">") ? "partial" : s;
							return [key, n, c, p]
						})(pos0.offset, pos0.line, pos0.column, result0[1], result0[3], result0[4], result0[5]);
					}
				...
				function parse_filters() {
					...
					if (result1 !== null) {
						result1 = (function (offset, line, column, n) {
							return n
						})(pos1.offset, pos1.line, pos1.column, result1[1]);
					}
					if (result1 === null) {
						pos = clone(pos1);
					}
				...
				function parse_array() {
					...
					if (result0 !== null) {
						...
						if (result1 !== null) {
							result1 = (function (offset, line, column, n) {
								return n.join('')
							})(pos4.offset, pos4.line, pos4.column, result1);
						}
						if (result1 === null) {
							pos = clone(pos4);
						}
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, a) {
							return a;
						})(pos2.offset, pos2.line, pos2.column, result0[1]);
					}
					if (result0 === null) {
						pos = clone(pos2);
					}
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, i, nk) {
							if (nk) {
								nk.unshift(i);
							} else {
								nk = [i]
				...
				function parse_array_part() {
					...
					if (result1 !== null) {
						result1 = (function (offset, line, column, k) {
							return k
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, d, a) {
							if (a) {
								return d.concat(a);
							} else {
								return d;
				...
				function parse_buffer() {
					...
					if (result0 !== null) {
						result0 = (function (offset, line, column, e, w) {
					...
					if (result0 === null) {
						...
						if (result1 !== null) {
							result1 = (function (offset, line, column, c) {
								return c
							})(pos1.offset, pos1.line, pos1.column, result1[2]);
						}
						if (result1 === null) {
							pos = clone(pos1);
						}
				...
				function parse_comment() {
					...
					if (result0 !== null) {
						...
						if (result2 !== null) {
							result2 = (function (offset, line, column, c) {
								return c
